...
[
  {
    "type": "TEXT",
    "name": "apiAccessToken",
    "displayName": "LI API Access Token",
...
conversion_event.conversionHappenedAt = eventModel.event_time || (Math.round(getTimestampMillis())); 
...
const userCompanyName = (eventModel.user_data != null && eventModel.user_data.company != null) ? eventModel.user_data.company : '';
const userJobTitle = (eventModel.user_data != null && eventModel.user_data.jobTitle != null) ? eventModel.user_data.jobTitle : '';
const userLinkedinFirstPartyUUID = (eventModel.user_data != null && eventModel.user_data.uuid != null) ? eventModel.user_data.uuid : '';
...
// eventId is an optional ID generated by you to indicate each event. Unless otherwise configured, this will be set to a combination of the client_id and the user_id
const eventID = (eventModel.user_id != null && eventModel.client_id != null) ? makeString(eventModel.user_id) + makeString(eventModel.client_id) : "";
...
conversion_event.userData = {userIds: [{'idType': 'SHA256_EMAIL',
                                       ...
                                       'idValue': userLinkedinFirstPartyUUID},
                                       {'idType': 'ACXIOM_ID',
...
const conversionAmmount = (eventModel.value != null) ? eventModel.value : "0.00";

const conversionValue =  {"currencyCode": conversionCurrency, 
                          "amount": conversionAmmount}; 
...
var postBody ={'conversion': conversionRuleUrn,
              'conversionHappenedAt':conversion_event.conversionHappenedAt,
