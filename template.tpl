...

{
  ...
  "description": "Utilize this template to begin streaming conversion events to LinkedIn\u0027s Conversion API endpoint.",
  "containerContexts": [
    "SERVER"
  ]
}
...
[
  ...
  },
  {
    "type": "TEXT",
    "name": "sha256Email",
    "displayName": "Email address of the contact associated with the conversion event which needs to be converted to lower case and then hashed in SHA256 format, a HEX encoded string with a maximum length of 64 characters.",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
    "name": "acxiomID",
    "displayName": "User identifier for matching with LiveRamp identity graph.",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
    "name": "moatID",
    "displayName": "User identifier for matching with Oracle MOAT Identity.",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
    "name": "li_fat_id",
    "displayName": "LinkedIn first party cookie or Click Id. Advertisers need to enable enhanced conversion tracking from Campaign Manager in order to activate first party cookies that appends a click ID parameter li_fat_id to the click URLs.",
    "simpleValueType": true
  }
]
...
const userEmailSHA256 = (eventModel.user_data != null && (eventModel.user_data.sha256_email_address != null && eventModel.user_data.sha256_email_address != "")) ? eventModel.user_data.sha256_email_address : ((data.sha256Email != null) ? data.sha256Email : ""); 
...
const userLinkedinFirstPartyID = (eventModel.user_data != null && (eventModel.user_data.linkedinFirstPartyId != null && eventModel.user_data.linkedinFirstPartyId != "")) ? eventModel.user_data.linkedinFirstPartyId : ((data.li_fat_id != null) ? data.li_fat_id : '');
const userAcxionID = (eventModel.user_data != null && (eventModel.user_data.acxiomID != null && eventModel.user_data.acxiomID != "")) ? eventModel.user_data.acxiomID : ((data.acxiomID != null) ? data.acxiomID : '');
const userMoatID = (eventModel.user_data != null && (eventModel.user_data.moatID != null && eventModel.user_data.moatID != "")) ? eventModel.user_data.moatID : ((data.moatID != null) ? data.moatID : '');

//leadGenID should be set to the LeadGenFormResponseUrn, generated when user submit LinkedIn lead-gen form, can be retrieved from the Lead Sync API
